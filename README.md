# PinktradeBot
🖱️ clicker for [https://t.me/pinktrade_bot](https://t.me/pinktrade_bot/pink?startapp=vaovea)
...
| Setting                      | Description                                                                                    |
|------------------------------|------------------------------------------------------------------------------------------------|
| query_id        | fill the `query.txt` file with your data, how to get data you can refer to [How to Get Data](#how-to-get-data)                      |
...
## Auto Install/Run
- click on START.bat to run the project
